...
open class OAuth2Swift: OAuthSwift {
    ...
    func postOAuthAccessTokenWithRequestTokenByCode(_ code: String, callbackURL: URL, headers: [String:String]? = nil, success: @escaping TokenSuccessHandler, failure: FailureHandler?) {
        ...
        parameters["redirect_uri"] = callbackURL.unsafeAbsoluteString.safeStringByRemovingPercentEncoding as AnyObject?
    ...
    fileprivate func requestOAuthAccessTokenWithParameters(_ parameters: [String : AnyObject], headers: [String: String]? = nil, success: @escaping TokenSuccessHandler, failure: FailureHandler?) {
        let successHandler: OAuthSwiftHTTPRequest.SuccessHandler = { [unowned self]
            ...
            if let jsonDico = responseJSON as? [String:AnyObject] {
                ...
                responseParameters = responseString.parametersFromQueryString() as [String : AnyObject]
            }
     ...
     */
    open func startAuthorizedRequest(_ url: String, method: OAuthSwiftHTTPRequest.Method, parameters: Dictionary<String, AnyObject>, headers: [String:String]? = nil, onTokenRenewal: TokenRenewedHandler? = nil, success: @escaping OAuthSwiftHTTPRequest.SuccessHandler, failure: @escaping OAuthSwiftHTTPRequest.FailureHandler) {
        // build request
    ...
    open func authorizeDeviceToken(_ deviceCode: String, success: @escaping TokenRenewedHandler, failure: @escaping OAuthSwiftHTTPRequest.FailureHandler) {
        ...
        parameters["client_id"] = self.consumer_key as AnyObject?
        parameters["client_secret"] = self.consumer_secret as AnyObject?
        parameters["code"] = deviceCode as AnyObject?
        parameters["grant_type"] = "http://oauth.net/grant_type/device/1.0" as AnyObject?
